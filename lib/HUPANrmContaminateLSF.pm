...
sub rmContaminate{
    ...
    getopts("hl:i:");
    my $usage="\nUsage: hupanLSF rmCtm [options] <sequence_file> <blast_file> <accession_file> <output_directory>

hupanLSF rmCtm is used to detect and discard the potentail contaminated sequence.
