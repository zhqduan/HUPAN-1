...
sub alignContig{
    ...
    getopts("hq:s:");
    my $usage="\nUsage:hupan align [options] <data_directory> <output_directory> <MUMmer_directory> <reference.fa>
...
sub extractSeq{
    ...
    getopts("hi:c:s:");
    my $usage="\nUsage: hupan extractSeq [options] <data_dir> <out_dir> <MUMmer_output_dir>
