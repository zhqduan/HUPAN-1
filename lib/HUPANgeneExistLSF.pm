...
my $usage="hupanLSF geneExist gene_file cds_file min_gene_cov min_cds_cov >output
...
my $usage="hupanLSF subSample gene_existence_matrix sample_list >output
";
...
my $usage="hupanLSF gFamExist <geneExist.txt> <geneFam.info> > geneFamExist.txt
";
