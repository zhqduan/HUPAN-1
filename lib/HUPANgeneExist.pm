...
my $usage="hupan geneExist gene_file cds_file min_gene_cov min_cds_cov >output
...
my $usage="hupan subSample gene_existence_matrix sample_list >output
";
...
my $usage="hupan gFamExist <geneExist.txt> <geneFam.info> > geneFamExist.txt
";
