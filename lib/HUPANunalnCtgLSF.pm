...
hupanLSF getUnalnCtg is used to collect unaligned contigs.
...
my $usage="\nUsage: hupanLSF mergeUnalnCtg [options] <unaln_directory> <output_prefix>  

hupanLSF mergeUnalnCtg is used to merge unaligned contigs of each individuals to a single file.
