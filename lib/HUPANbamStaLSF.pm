...
my $usage="\nUsage: hupanLSF bamSta basic [options]  <bam_directory> <output_directory> <bamUtil_directory>

hupanLSF bamSta basic is used to check the basic statistics of mapping.
...
my $usage="\nUsage: hupanLSF bamSta cov [options]  <bam_directory> <output_directory> <qualimap_directory>

hupanLSF bamSta cov is used to check the coverages of the genome.
...
my $usage="\nUsage: hupanLSF bamSta mergeBasicSta [options] <directory> >output

hupanLSF bamSta mergeBasicSta is used to collect and merge bam basic statistics.
...
sub mergeCovSta{
    ...
    my $usage="\nUsage: hupanLSF bamSta mergeCovSta [options] <directory> >output

hupanLSF bamSta mergeCovSta is used to collect and merge bam coverage statistics.
