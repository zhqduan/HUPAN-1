...
sub checkQual{
    ...
    my $usage="\nUsage: hupanSLURM qualSta [options] <data_directory> <output_directory>
...
sub mergeFastqc{
    use strict;
    use warnings;
    die "Usage: hupanSLURM mergeQualSta <directory>
directory  <string>  The exact output of \"hupanSLURM qualSta\".
" if @ARGV<1;
    my $out_dir=$ARGV[0];
    unless($out_dir=~/\/$/){
	$out_dir.="/";
