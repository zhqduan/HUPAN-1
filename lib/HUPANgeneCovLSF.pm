...
my $usage="\nUsage: hupanLSF geneCov [options]  <bam_directory> <output_directory> <gene_annotation>

hupanLSF geneCov is used to calculate gene coverages of each gene.
...
sub merge{
    my $usage="\nUsage: hupanLSF mergeGeneCov <output_prefix> <data_directory> 
";
    die $usage if @ARGV!=2; 
    my ($prefix,$d)=@ARGV;
