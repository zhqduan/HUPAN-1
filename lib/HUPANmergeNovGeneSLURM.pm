...
sub mergeNovGene{
    ...
    getopts("hp:j:");
    my $usage="\nhupanSLURM mergeNovGen [options] <data_directory> <output_directory> <maker_directory>

hupanSLURM mergeNovGen is used to merge maker result from multiple files.
