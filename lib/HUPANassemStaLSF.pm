...
my $usage="\nUsage: hupanLSF assemSta [options]  <assembly_directory> <output_directory> <QUAST_directory> <reference.fa>

hupanLSF assemSta is used to map assembled contigs to reference and to check the statistics of assembled contigs (or scaffolds).
...
my $usage="\nUsage: hupanLSF mergeAssemSta <QUAST_output_directory_list> > output_statistics

hupan LSF mergeAssemSta is used to collect statistices info of assembly from quast.
