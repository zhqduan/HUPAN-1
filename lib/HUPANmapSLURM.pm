...
my $usage="\nUsage: hupanSLURM align [options]  <fastq_data_directory> <output_directory> <Mapping_tool_directory> <alignment_index>

hupanSLURM align is used to map high-quality reads to a reference on large scale.
