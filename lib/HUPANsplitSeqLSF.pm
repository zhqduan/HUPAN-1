...
sub splitSeq{
    ...
    getopts("hm:");
    my $usage="\nUsage: hupanSLF splitSeq [options] <sequence_file> output_directory

hupanSLF splitSeq is used to split sequence file into multiple small file.
...
#check existense of output directory
    if(-e $out_dir){
        die("Error: output directory \"$out_dir\" already exists.\nTo avoid overwriting of
 existing files. We kindly request that the \noutput directory should not exist.\n");
    }
