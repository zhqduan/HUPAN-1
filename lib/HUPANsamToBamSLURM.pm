...
my $usage="\nUsage: hupanSLURM sam2bam [options]  <mapping_directory> <output_directory> <samtools_directory>

hupanSLURM sam2bam is used to adjust mapping results including: 1)coverting sam to bam 2)sorting bam 3)merging 
bam 4)indexing bam.
